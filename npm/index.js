...
class genderdetectorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/genderdetector');
        }
        ...
        this.validationRules = {"name":{"type":"string","required":true},"country":{"type":"string","required":false,"minLength":2,"maxLength":2,"default":"us"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/genderdetector`);
        }
    }
...
module.exports = genderdetectorWrapper;
