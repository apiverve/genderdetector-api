...
namespace APIVerve\Genderdetector;
...
/**
 * Client for the Gender Detector API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/genderdetector?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/genderdetector';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\GenderdetectorClient] {$message}\n";
        }
    }
}
