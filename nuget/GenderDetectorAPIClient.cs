...
namespace APIVerve.API.GenderDetector
{
    ...
    /// <summary>
    /// Client for the GenderDetector API
    /// </summary>
    public class GenderDetectorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/genderdetector";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "country", new ValidationRule { Type = "string", Required = false, MinLength = 2, MaxLength = 2 } }
        };
        ...
        public GenderDetectorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GenderDetectorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GenderDetectorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, GenderDetectorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(GenderDetectorQueryOptions options)
        {
        ...
        public ResponseObj Execute(GenderDetectorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(GenderDetectorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(GenderDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(GenderDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(GenderDetectorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(GenderDetectorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(GenderDetectorQueryOptions options)
        {
