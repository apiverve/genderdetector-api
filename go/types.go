...
// Request contains the parameters for the Gender Detector API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"country": {Type: "string", Required: false, MinLength: intPtr(2), MaxLength: intPtr(2)},
	}
...
// ResponseData contains the data returned by the Gender Detector API.
