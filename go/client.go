// Package genderdetector provides a Go client for the Gender Detector API.
//
// For more information, visit: https://apiverve.com/marketplace/genderdetector?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/genderdetector"
	defaultTimeout = 30 * time.Second
)

// Client is the Gender Detector API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Gender Detector API client.
...
// Execute makes a request to the Gender Detector API with typed parameters.
//
...
//   - name (required): string - The name for which you want to detect the gender
//   - country: string - The country code for the name (e.g., US) [minLength: 2, maxLength: 2]
