...
```gradle
dependencies {
    implementation 'com.github.apiverve:genderdetector-api:1.1.12'
}
```
...
```java
import com.apiverve.genderdetector.GenderDetectorAPIClient;
import com.apiverve.genderdetector.APIResponse;
import com.apiverve.genderdetector.APIException;

// Initialize the client
GenderDetectorAPIClient client = new GenderDetectorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/genderdetector](https://docs.apiverve.com/ref/genderdetector)
...
- **Documentation:** [https://docs.apiverve.com/ref/genderdetector](https://docs.apiverve.com/ref/genderdetector)
- **Issues:** [GitHub Issues](https://github.com/apiverve/genderdetector-api/issues)
